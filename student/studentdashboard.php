...
<div class="row">
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Available Scholarships</div>
  ...
  <?php
            ...
            $retrieve = mysqli_query($conn, "select * from scholar where status='Approved' and total_student > 1 "); 
                 ...
                 echo "<table class='table'> ";
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                      ...
                      echo "<td><div class='book'><a href='apply.php?scholar_id=$scholar_id'> Apply Scholarship </a></div> </td>";
