...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:lightgrey;">
      ...
      <br>
       <ol class="breadcrumb">
          ...
          <li class="active">REJECTED SCHOLARSHIP APPLICATION </li>
       </ol>
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Rejected Scholarships Application </div>
  ...
  <?php
            ...
            //$retrieve = mysqli_query($conn, "select * from application where status='Rejected'"); 
           $email = $_SESSION['email'];

            $retrieve = mysqli_query($conn, "select * from student join application on student.student_id=application.student_id where status='Rejected'"); 
