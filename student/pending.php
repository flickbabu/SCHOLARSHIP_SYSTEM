...
<div class="row">
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Pending Scholarships Application </div>
  ...
  <?php
   ...
   $email = $_SESSION['email'];
            ...
            $retrieve = mysqli_query($conn, "select * from student join application on student.student_id=application.student_id where status='Pending'"); 
