...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:lightgrey;">
      ...
      <br>
       <ol class="breadcrumb">
          ...
          <li class="active">REJECTED SCHOLARSHIP DETIALS</li>
       </ol>
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Rejected Scholarship</div>
  ...
  <?php
            ...
            $retrieve = mysqli_query($conn, "select * from scholar where status='Rejected' and sch_del=9 "); 
                 ...
                 echo "<table class='table'> ";
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                      ...
                      echo "<td><div class='book'><a href='deleter.php?scholar_id=$scholar_id' onclick=\"return confirm('Are you sure you want to delete this Scholarship ?');\"><i class='glyphicon glyphicon-trash'></i> Remove </a></div> </td>";
