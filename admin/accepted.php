...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:lightgrey;">
      ...
      <br>
       <ol class="breadcrumb">
          ...
          <li class="active">ACCEPTED SCHOLARSHIP DETIALS</li>
       </ol>
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Accepted Scholarship</div>
  ...
  <?php
            ...
            $retrieve = mysqli_query($conn, "select * from scholar where status='Approved' and sch_del=9 "); 

            if(mysqli_num_rows($retrieve)==0)

                {
                    echo "<h3>No Approved Scholarship</h3>";  
                }
                 ...
                 echo "<table class='table'> ";
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                      ...
                      echo "<td><div class='book'><a href='deleteapp.php?scholar_id=$scholar_id' onclick=\"return confirm('Are you sure you want to delete this Scholarship ?');\"><i class='glyphicon glyphicon-trash'></i> Remove </a></div> </td>";
