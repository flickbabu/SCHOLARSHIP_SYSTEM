...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:lightgrey;">
      ...
      <br>
       <ol class="breadcrumb">
          ...
          <li class="active">REJECTED SCHOLARSHIP APPLICATIONS</li>
       </ol>
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Rejected Scholarship Application </div>
      ...
      <?php
            ...
            $retrieve = mysqli_query($conn, "select * from application where status='Rejected' and app_del=6 "); 

            if(mysqli_num_rows($retrieve)==0)

                {
                    echo "<h3>No Rejected Applications </h3>";  
                }
                 ...
                 echo "<table class='table'> ";
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                      ...
                      echo "<td><div class='book'><a href='appdelete.php?application_id= $application_id' onclick=\"return confirm('Are you sure you want to delete this Application ?');\"><i class='glyphicon glyphicon-trash'></i> Remove </a></div> </td>";
