...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:lightgrey;">
      ...
      <br>
       <ol class="breadcrumb">
          ...
          <li class="active">PENDING SCHOLARSHIP APPLICATION</li>
       </ol>
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-graduation-cap" aria-hidden="true"></i>Scholarship Applications </div>
  ...
  <?php
            ...
            $retrieve = mysqli_query($conn, "select * from application where status='Pending'"); 

            if(mysqli_num_rows($retrieve)==0)

                {
                    echo "<h3>No Pending Applications</h3>";  
                }
                 ...
                 echo "<table class='table'> ";
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                      ...
                      echo "<td><div class='book'><a href='details.php?application_id=$application_id'>View Details </a></div>
                      </td>";
