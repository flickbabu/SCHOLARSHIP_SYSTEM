...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:lightgrey;">
      ...
      <br>
       <ol class="breadcrumb">
          ...
          <li class="active">ADMIN DETIALS</li>
       </ol>
   ...
   <div class="panel panel-default">
    ...
    <div class="page-heading"> <i class="fa fa-users" aria-hidden="true"></i> Admin Details</div>
  ...
  <?php
            ...
            $retrieve = mysqli_query($conn, "select * from admin "); 

            if(mysqli_num_rows($retrieve)==0)

                {
                    echo "<h3>No admin Available</h3>";
                }
                 ...
                 echo "<table class='table'> ";
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                            ...
                            //echo "<td><div class='book'>".$row['brand_status']."</div></td>";
